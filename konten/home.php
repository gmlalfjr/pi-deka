		...
		<div class="row">
			<div class="col-md-4">
				...
				<a class="nanogallery" href="gambar/artikel/
					...
					<img src="gambar/artikel/<?= $data['gambar']; ?>" class="img-thumbnail" width=100% height="300px" style="margin-bottom: 10px;">
				</a>
			</div>
			<div class="col-md-8">
				<p style="line-height: 22px">&nbsp;&nbsp;&nbsp;&nbsp;<?= $isi; ?> ....
					<a href="?tampil=artikel_detail&id=
    				<?= $data['id_artikel']; ?>" class="btn btn-primary btn-xs">Selengkapnya</a>
				</p>
			</div>
		</div>
	</div>
